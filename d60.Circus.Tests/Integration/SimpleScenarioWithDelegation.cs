...
")]
    public class SimpleScenarioWithDelegation : FixtureBase
    {
        ...
        public void RunEntirePipelineAndProbePrivatesForMultipleAggregates()
        {
            ...
            _circus.ProcessCommand(new BearSomeChildrenCommand(firstAggregateRootId, new[] { firstChildId, secondChildId }));

            var afterBearingTwoChildren = GetAllRoots();

            _circus.ProcessCommand(new BearSomeChildrenCommand(firstChildId, new[] { grandChildId }));
