...
using d60.Cirqus.Tests.Projections.Views.NewViewManager.Commands;
using d60.Cirqus.Tests.Projections.Views.NewViewManager.Views;
using MongoDB.Driver;
using NUnit.Framework;

namespace d60.Cirqus.Tests.Projections.Views.NewViewManager
{
