...
namespace d60.Cirqus.Tests.Projections.Views
{
    ...
    {
        Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<SomeViewInstance> _viewManager;
        ...
        {
            _viewManager = new Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<SomeViewInstance>();
