...
namespace d60.Cirqus.Tests.Projections.Views
{
    [TestFixture]
    public class TestLoadAggregatesFromView : FixtureBase
    {
        CommandProcessor _cirqus;
        Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<MyViewInstance> _viewManager1;
        Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<MyViewInstanceImplicit> _viewManager2;
        Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<MyViewInstanceEmitting> _viewManager3;

        protected override void DoSetUp()
        {
            var eventStore = new InMemoryEventStore();
            _viewManager1 = new Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<MyViewInstance>();
            _viewManager2 = new Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<MyViewInstanceImplicit>();
            _viewManager3 = new Cirqus.Projections.Views.ViewManagers.Old.InMemoryViewManager<MyViewInstanceEmitting>();
