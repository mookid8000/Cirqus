...
namespace d60.Cirqus.Extensions
{
    public static class EventExtensions
    {
        ...
        /// </summary>
        public static Guid GetAggregateRootId(this EventData domainEvent, bool throwIfNotFound = true)
        {
        ...
        static TValue GetMetadataField<TValue>(EventData domainEvent, string key, Func<object, TValue> converter, bool throwIfNotFound)
        {
