...
namespace d60.Cirqus.Aggregates
{
    ...
    public interface IAggregateRootRepository
    {
        ...
        /// </summary>
        AggregateRootInfo<TAggregate> Get<TAggregate>(string aggregateRootId, IUnitOfWork unitOfWork, long maxGlobalSequenceNumber = long.MaxValue, bool createIfNotExists = false) where TAggregate : AggregateRoot, new();
        ...
        /// </summary>
        bool Exists<TAggregate>(string aggregateRootId, long maxGlobalSequenceNumber = long.MaxValue, IUnitOfWork unitOfWork = null) where TAggregate : AggregateRoot;
    }
}