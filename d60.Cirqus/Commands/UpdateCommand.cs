...
{
    public abstract class UpdateCommand<TAggregateRoot> : Command where TAggregateRoot : AggregateRoot, new()
    {
        ...
        {
            var aggregateRootInstance = context.Load<TAggregateRoot>(AggregateRootId, createIfNotExists: false);
